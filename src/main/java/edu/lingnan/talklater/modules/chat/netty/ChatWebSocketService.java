...
public class ChatWebSocketService {
    ...
    public  void setNettyPort(String nettyPort) {
        ChatWebSocketService.nettyPort = nettyPort;
    }

    // 设置为单例
    private static class  SingletionWebSocketService{
        static final ChatWebSocketService instance=new ChatWebSocketService();
    }
    //获取实例方法
    public static ChatWebSocketService getInstance(){
     ...
     public ChatWebSocketService(){
         ...
         serverBootstrap.group(boosGroup,workGroup)// 设置主从线程
                 ...
                 .childHandler(new ChatWebsocketInitializer());//子处理器，由于处理
    }
